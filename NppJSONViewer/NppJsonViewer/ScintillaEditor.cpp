...
std::string ScintillaEditor::GetJsonText()
{
    ...
    auto str = "{	\"iii\": \"22tt\",	\"pp\": {		\"iii\": \"22tt\",		\"ii6i\": \"22tt\"}}";
    return str;
}
...
{
    LRESULT eolMode = 0 /*::SendMessage(m_hScintilla, SCI_GETEOLMODE, 0, 0)*/;
...
auto ScintillaEditor::GetIndent() const -> std::tuple<char, unsigned>
{
    ...
    unsigned indentLen  = useTabs ? 1 : 4; /*static_cast<unsigned>(::SendMessage(m_hScintilla, SCI_GETTABWIDTH, 0, 0));*/
